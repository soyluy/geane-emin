// src/app/components/ui/EmailOtpContent.tsx
...
type Props = {
  /** Ekranda gösterilecek e-posta adresi */
  email?: string;
...
const EmailOtpContent: React.FC<Props> = ({
  email = "admin@geane.com",
  expiresAt,
  initialSeconds = 180,
  onComplete,
  onResend,
    ...
    <View style={styles.root} onLayout={onLayout}>
      ...
      <View style={[styles.absFullWidth, { top: textTop, left: hPad, right: hPad }]} pointerEvents="none">
        <Text style={styles.infoText} numberOfLines={2}>
          <Text style={styles.infoBold}>{email}</Text>
          <Text>{"  adresine\n"}</Text>
      ...
      >
        <View style={styles.codeContainer}>
          ...
          {/* Gizli input (autofill açık kalabilir – iOS/Android oneTimeCode alanı e-posta OTP’lerde de çalışabilir) */}
          <TextInput
            ref={inputRef}
            value={codeStr}
...
export default EmailOtpContent;
